...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [131 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2033152, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12743560; uint32_t buffer_offset
	}, ; 128: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12914568; uint32_t buffer_offset
	}, ; 129: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2077696, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12937128; uint32_t buffer_offset
	} ; 130: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15014824, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15014824 x i8] zeroinitializer, align 1
