...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001d41, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001d40, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [873 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x0c6f7a712d4b04cf, ; from name: aot-clCalculadora.so
		i64 u0xab568c50dc7bd273, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-clCalculadora.dll.so
		ptr null; void* handle
	}, ; 54
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.79_name, ; name: libaot-System.Net.Mail.dll.so
		ptr null; void* handle
	}, ; 74
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x14c57d3286b9573e, ; from name: mobCalc.so
		i64 u0x4a5319888e23d4fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobCalc.dll.so
		ptr null; void* handle
	}, ; 81
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x1c5098f1638b9235, ; from name: aot-clCalculadora.dll.so
		i64 u0xab568c50dc7bd273, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-clCalculadora.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x1c88cd4e00776d36, ; from name: libaot-clCalculadora.so
		i64 u0xab568c50dc7bd273, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-clCalculadora.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x24d5c876f837b27b, ; from name: aot-mobCalc
		i64 u0x4a5319888e23d4fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobCalc.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x26e15b8d0666235c, ; from name: libaot-mobCalc.so
		i64 u0x4a5319888e23d4fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobCalc.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x49d40d07349fd5e5, ; from name: aot-mobCalc.so
		i64 u0x4a5319888e23d4fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobCalc.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x4a5319888e23d4fd, ; from name: libaot-mobCalc.dll.so
		i64 u0x4a5319888e23d4fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobCalc.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x59ffc4cf59dae872, ; from name: clCalculadora.so
		i64 u0xab568c50dc7bd273, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-clCalculadora.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x6b13966cee5f8d24, ; from name: libaot-mobCalc
		i64 u0x4a5319888e23d4fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobCalc.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x8291499783159334, ; from name: mobCalc.dll.so
		i64 u0x4a5319888e23d4fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobCalc.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x879b42c9964c2a2a, ; from name: aot-clCalculadora
		i64 u0xab568c50dc7bd273, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-clCalculadora.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xab568c50dc7bd273, ; from name: libaot-clCalculadora.dll.so
		i64 u0xab568c50dc7bd273, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-clCalculadora.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xac24b9dbf0ef4664, ; from name: aot-mobCalc.dll.so
		i64 u0x4a5319888e23d4fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobCalc.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xbfcc30424f23d0a6, ; from name: libaot-clCalculadora
		i64 u0xab568c50dc7bd273, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-clCalculadora.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xc45bde82384837cd, ; from name: mobCalc
		i64 u0x4a5319888e23d4fd, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libaot-mobCalc.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xe85981f9f97acddf, ; from name: clCalculadora.dll.so
		i64 u0xab568c50dc7bd273, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-clCalculadora.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xf9f3f136e4f253c9, ; from name: clCalculadora
		i64 u0xab568c50dc7bd273, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-clCalculadora.dll.so
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [28 x i8] c"libaot-clCalculadora.dll.so\00", align 16
@.DSOCacheEntry.9_name = private unnamed_addr constant [22 x i8] c"libaot-mobCalc.dll.so\00", align 16
...
@.DSOCacheEntry.79_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 16
